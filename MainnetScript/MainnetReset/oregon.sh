...
temp=mainnet_reset.sh
#need changes here
configFileFirstPart="/config."
...
declare -a publicIp=(
"ec2-34-212-34-162.us-west-2.
peerScriptPath=/home/avinash/Desktop/SCriptForRunningNodeOnAWS/peerScript.sh
...
"ec2temp=/home/avinash/temp.sh
-34-212-30-116.us-west-2.compute.amazonaws.com"
...
for i in ${!publicIp[*]};
do
#concatenate strings to form username@IPAddress
address=$address1${publicIp[$i]}
echo $address
#execute a reset script on AWS instances
